...
class Updater:
    ...
    def load_sample_with_forget(self, i):
        ...
        try:
            ...
            if (self.cnt_round+1) % self.dic_traffic_env_conf["FORGET_ROUND"] == 0 or self.cnt_round==29 or self.cnt_round==9 or self.cnt_round==49:
    ...
    def load_sample_for_agents(self):
        ...
        if self.dic_traffic_env_conf['MODEL_NAME'] in ["PressLight",  "MPLight", "MPLightAttention",
                                                       "AdvancedMPLight", "SimpleDQN", "LiteFRAP", "Attend","General"]:
            sample_set_all = []
